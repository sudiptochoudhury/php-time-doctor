...
class Cli extends AbstractCli
{
    ...
    protected $welcome = 'Time Doctor API CLI tool';
    protected $apiProvider = 'TimeDoctor';

    protected $apiServiceDefPath = 'src/TimeDoctor/config/timedoctor.json';
    protected $apiService = [];
    protected $config = [];
    protected $commandOptions = []; // API options


    protected $configFile = 'timedoctor.json';
    protected $log = null;
    protected $env = 'dev';
